...
class Settings(BaseSettings):
    ...
    rabbitmq_user: str = "waslini"
    rabbitmq_password: str = "waslini"
...
class ConfigAdapter(IConfig):
    ...
    def rabbitmq_user(self) -> str:
        return self._settings.rabbitmq_user

    @property
    def rabbitmq_password(self) -> str:
        return self._settings.rabbitmq_password

    @property
    def worker_interval(self) -> int:
        return self._settings.worker_interval
